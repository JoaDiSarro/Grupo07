...
public final class PokemonElectrico extends PokemonDecorator {
	 ...
	 * <b>Post:</b> Se le agrega al pokemon la funcionalidad del elemento
	 * electrico.<br>
	 * 
	...
	/**
	 * Metodo por el cual el Pokemon Electrico realiza una recarga de su fuerza y
	 * vitalidad.<br>
	...
	/**
	 * Metodo por el cual el Pokemon Electrico le provoca a su adversario un daño
	 * igual a su fuerza.<br>
	 * Luego su fuerza se reduce un 10%.<br>
	 * <b>Pre:</b> el pokemon pasado por parametro debe ser distinto de null.<br>
	 * <b>Post:</b> El pokemon electrico le realiza un daño al pokemon pasado como
	 * parametro. Luego disminuye su fuerza un 10%.<br>
	 * 
	 ...
	 * <b>Post:</b> El Pokemon Electrico recibe cierta cantidad de daño. Existe la
