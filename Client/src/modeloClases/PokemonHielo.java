...
public class PokemonHielo extends PokemonDecorator {
    ...
    public void golpeFinal(Pokemon pokemon){
        pokemon.recibeDaño(this.pokemon.fuerza*0.90);    
    }
    ...
    public void recibeDaño(double daño){
        double aux = 0;
        if(daño*0.75 < this.pokemon.escudo)
        	this.pokemon.escudo -= daño*0.75;
        else{
            aux = daño*0.75 - escudo;
            this.pokemon.escudo = 0;
        }
        
        if((daño*0.25 + aux) < this.pokemon.vitalidad)     
        	this.pokemon.vitalidad -= daño*0.25 + aux;
        else
    ...
    public void hechizarNiebla() {
    	double auxFuerza = this.pokemon.fuerza*0.3;
    	
    	if (auxFuerza>this.pokemon.escudo)
    		this.pokemon.escudo=0;
    	else
    		this.pokemon.escudo-=auxFuerza;
    	if (auxFuerza>=this.pokemon.vitalidad)
    		this.pokemon.vitalidad=1;
    	else
    		this.pokemon.vitalidad-=auxFuerza;
    ...
    public void hechizarViento() {
    	double auxValor = (this.pokemon.vitalidad*0.1) + (this.pokemon.escudo*0.1);
    	
        if (auxValor >= this.pokemon.fuerza)
        	this.pokemon.fuerza=1;
        else
        	this.pokemon.fuerza-=auxValor;
    }
