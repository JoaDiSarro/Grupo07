...
public class PokemonHielo extends PokemonDecorator {
	...
	/**
	 * Metodo por el cual el Pokemon de Hielo le provoca al adversario un daño igual
	 * a su fuerza menos un 10%.<br>
	 * Conserva la misma fuerza original.<br>
	 * <b>Pre:</b> el pokemon pasado por parametro debe ser distinto de null.<br>
	 * <b>Post:</b> El pokemon de Hielo le realiza un daño al pokemon pasado como
	 * parametro.<br>
	 * 
	 ...
	 * <b>Post:</b> El Pokemon de Hielo recibe cierta cantidad de daño. Existe la
	 ...
	 * Si el porcentaje de fuerza es mayor o igual a la vitalidad, ésta se vuelve
	 * 1.<br>
	 ...
	 * En caso de ser menor o igual la fuerza que la suma de estos valores, se
	 * vuelve 1.<br>
