...
public final class PokemonFuego extends PokemonDecorator {
	...
	/**
	 * Metodo por el cual el Pokemon de Fuego realiza una recarga de su fuerza y
	 * vitalidad.<br>
	...
	/**
	 * Metodo por el cual el Pokemon de Fuego le provoca al adversario un daño igual
	 * a su fuerza mas un 25%<br>
	 * Luego la fuerza se agota por completo (queda en cero)<br>
	 * <b>Pre:</b> el pokemon pasado por parametro debe ser distinto de null<br>
	 * <b>Post:</b> El pokemon de Fuego le realiza un daño al pokemon pasado como
	 * parametro. Luego disminuye su fuerza a cero<br>
	 * 
	 ...
	 * El escudo y la vitalidad absorben la mitad del daño cada uno
	 * (decrementándose).<br>
	 * <b>Pre:</b> El daño pasado como parametro debe ser distinto de null<br>
	 * <b>Post:</b> El Pokemon de Fuego recibe cierta cantidad de daño. Existe la
	 ...
	 * En caso de ser mayor o igual la vitalidad actual al 10% de la fuerza, la
	 * fuerza se vuelve 1.<br>
