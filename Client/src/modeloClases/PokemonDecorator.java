 ...
 * @version 1.0 <br>
 *          Clase que se encarga de decorar Pokemones dandoles asi distintos
 *          tipos de funcionalidades dependiendo el Elemento que sean.<br>
...
public abstract class PokemonDecorator extends Pokemon implements Cloneable {
	 ...
	 * <b>Pre:</b> El parametro pokemon debe ser distinto de null. Ademas,
	 * vitalidad, fuerza y escudo deben ser distinto de null y mayores a 0.<br>
	 * <b>Post:</b> Se decora un pokemon con un elemento especifico.<br>
	 * 
	 * @param pokemon   de tipo Pokemon : Se encarga de guardar la referencia a
	 *                  memoria de un Pokemon base.<br>
	...
	/**
	 * Método encargado de clonar un pokémon de cualquier elemento. <b>Post:</b> Se
	 * clona el objeto.<br>
	 */
	@Override
	public Object clone() {
	 ...
	 */
	/*
	 * @Override public String toString() { return "Nombre: "+this.nombre+" | "+
	 * "Vitalidad: "+this.vitalidad+" | "+ "Escudo: "+this.escudo+" | "+
