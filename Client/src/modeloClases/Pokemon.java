 ...
 * @version 1.0 <br>
 *          Esta clase contiene los atributos y metodos correspondientes a un
 *          Pokemon.<br>
 *          Pokemon es una clase abstracta e implementa las interfaces
 *          Cloneable, IHechizable,IClasificable.<br>
 */
...
public abstract class Pokemon implements Cloneable, IHechizable, IClasificable, Serializable {
	...
	/**
	 * Metodo Constructor parametrizado.<br>
	 * Por defecto su experiencia comienza con valor = 0 y su clasificacionActual =
	 * 1.<br>
	 * <b>Pre:</b> El parametro nombre debe ser distinto de null. Ademas, vitalidad,
	 * fuerza y escudo deben ser distinto de null y mayores a 0.<br>
	 * <b>Post:</b>Se genera un nuevo Pokemon.<br>
	 * 
	 * @param nombre    de tipo String: hace referencia al nombre del Pokemon a
	 *                  crear.<br>
	 * @param vitalidad de tipo double: hace referencia a la vitalidad del Pokemon a
	 *                  crear.<br>
	 * @param fuerza    de tipo double: hace referencia a la fuerza del Pokemon a
	 *                  crear.<br>
	 * @param escudo    de tipo double: hace referencia al escudo del Pokemon a
	 *                  crear.<br>
	 */
	...
	/**
	 * Constructor parametrizado <b>Pre:</b> El parametro nombre debe ser distinto
	 * de null.<br>
	 * <b>Post:</b>Se genera un nuevo Pokemon.<br>
	 * 
	 * @param nombre de tipo String: hace referencia al nombre del Pokemon a
	...
	/**
	 * Método encargado de sumar experiencia a un pokémon cuando gana una
	 * batalla.<br>
	...
	/**
	 * Método encargado de sumar experiencia a un pokémon cuando pierde una
	 * batalla.<br>
	 ...
	 * <b> Post: </b> El pokémon puede subir de nivel, incrementando sus
	 * atributos.<br>
	 */
	public void actualizaClasificacion() {
		...
		} else if (this.clasificacionActual == 2) {
	...
	public void ataca(Pokemon pokemon) {
		// System.out.println("\n-->"+this.nombre+" realiza su secuencia de
		// ataque..\n");
	...
	/**
	 * Metodo donde se le realiza un golpe inicial al pokemon pasado como parametro.
	 * Una vez realizado el daño, el Pokemon actual se cansa disminuyendo asi su
	 * fuerza en un 50%. <b>Pre:</b> El parametro pokemon debe ser distinto de
	 * null.<br>
	 * <b>Post:</b> Se le realiza un golpe al objeto pasado como parametro, y el
	 * pokemon actual disminuye su fuerza.<br>
	 * 
	 * @param pokemon de tipo Pokemon: Pokemon al que se le hara daño.<br>
	 */
	 ...
	 * 
	 * @param pokemon de tipo Pokemon: pokemon con el cual compararemos a nuestro
	 *                Pokemon.<br>
	 * @return devuelve un int, el cual puede ser 1 si nuestro pokemon es mejor que
	 *         el pasado como parametro, o 0 si es peor.<br>
	 */
	public int comparaEstado(Pokemon pokemon) {
		...
		if (estadoPropio > estadoAjeno)
			auxRetorno = 1;
		else if (estadoPropio < estadoAjeno)
			auxRetorno = 0;
		else if (this.experiencia > pokemon.getExperiencia())
			auxRetorno = 1;
		else if (this.experiencia < pokemon.getExperiencia())
			auxRetorno = 0;
		else
	...
	public String toString() {
		return "Nombre: " + this.nombre + " | " + "Vitalidad: " + this.vitalidad + " | " + "Escudo: " + this.escudo
				+ " | " + "Fuerza: " + this.fuerza + " | " + "Experiencia: " + this.experiencia + " | "
