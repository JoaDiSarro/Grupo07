...
public class Entrenador extends Observable implements IClasificable, Cloneable {
	 ...
	 * <b> Pre : </b> Los parametros deben ser distintos de null y no deben estar
	 * vacíos. El parámetro cartasDisponibles debe ser mayor o igual a 0.<br>
	 * 
	 * @param nombre            de tipo String : Representa el nombre del
	 *                          entrenador.<br>
	 * @param cartasDisponibles de tipo int : Representa la cantidad de cartas
	 *                          disponibles que puede usar el entrenador durante el
	 *                          torneo.
	 */
	 ...
	 * 
	 * @param listaCartas de tipo ArrayList<Carta> : Representa la lista de cartas
	 *                    que se le añade al entrenador.
	 */
	...
	/**
	 * Método encargado de agregar un objeto de tipo Pokemon a la lista
	 * pokemones.<br>
	 * <b> Pre: </b> El parámetro de tipo Pokemon debe ser distinto de null.<br>
	 * <b> Post: </b> Se agrega un pokemon a la lista.<br>
	 * 
	 * @param pokemon de tipo Pokemon: Representa el pokemon a añadir en la lista de
	 *                pokemones.
	 */
	...
	/**
	 * Método que permite a un entrenador utilizar una de sus cartas de manera
	 * aleatoria, afectando un objeto IHechizable.<br>
	 * <b> Pre: </b> El parámetro pokemon debe ser distinto de null.<br>
	 * <b> Post: </b> El IHechizable parámetro será hechizado por una carta y el
	 * Entrenador tendrá 1 carta menos para utilizar.<br>
	 * 
	 * @param pokemon de tipo IHechizable : Representa el objeto a hechizar con una
	 *                carta.
	 */
	...
	/**
	 * Método encargado de actualizar e incrementar la clasificaciónActual de un
	 * entrenador.<br>
	 * <b> Pre: </b> La lista de pokemones no debe estar vacía.<br>
	 * <b> Post: </b> Puede que el entrenador aumente su clasificacion, mejorando
	 * los atributos de sus pokemones.<br>
	 */
	@Override
	...
	/**
	 * Método encargado de eliminar un pokémon de la lista de pokemones del
	 * entrenador.<br>
	 * <b> Pre: </b> El parámetro pokemon debe ser distinto de null.<br>
	 * <b> Post: </b> En caso de existir, se elimina el elemento pokemon de la lista
	 * de pokemones.<br>
	 * 
	 * @param pokemon de tipo Pokemon : Representa el pokémon a eliminar de la
	 *                lista.
	 */
	...
	/**
	 * Metodo por el cual un Entrenador verifica si tiene cartas disponibles para
	 * utilizar.<br>
	 * 
	 * @return true en caso de poder utilizar una carta.<br>
	 * @throws SinCartasDisponiblesException se lanza en caso de no tener cartas
	...
	public boolean cartaDisponible() throws SinCartasDisponiblesException {
		...
		if (this.cartasDisponibles > 0)
			...
			throw new SinCartasDisponiblesException("\n-->El entrenador " + this.nombre
					+ " quizo utilizar una carta, pero ya agotó su cantidad de usos.\n");
		return auxRandom;
	}
