...
public final class PokemonTierra extends PokemonDecorator {
	...
	/**
	 * Metodo por el cual el Pokemon Electrico realiza una recarga de su fuerza
	 * completa.<br>
	...
	/**
	 * Metodo por el cual el Pokemon de Tierra le provoca a su adversario un daño
	 * igual a su fuerza mas un 40%.<br>
	 * Conserva su fuerza.<br>
	 * <b>Pre:</b> el pokemon pasado por parametro debe ser distinto de null.<br>
	 * <b>Post:</b> El pokemon de tierra le realiza un daño al pokemon pasado como
	 * parametro.<br>
	 * 
	 ...
	 * <b>Post:</b> El Pokemon de Tierra recibe cierta cantidad de daño. Existe la
	 ...
	 * Si el porcentaje de vitalidad es mayor o igual a la fuerza, ésta se vuelve
	 * 1.<br>
