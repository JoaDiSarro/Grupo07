...
public class Torneo extends Observable implements Observer {
	...
	/**
	 * Método encargado de agregar un entrenador a la lista de entrenadores.<br>
	 * 
	...
	/**
	 * Método encargado de agregar una arena al torneo.<br>
	 * 
